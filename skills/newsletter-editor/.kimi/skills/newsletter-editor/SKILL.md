...
# Newsletter Editor — Kimi Code CLI wrapper

This is the **Kimi Code CLI wrapper** for `newsletter-editor`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `/newsletter-editor`
- "run newsletter-editor"
