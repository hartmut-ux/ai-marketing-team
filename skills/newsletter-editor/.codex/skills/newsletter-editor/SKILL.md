...
# Newsletter Editor — Codex CLI wrapper

This is the **Codex CLI wrapper** for `newsletter-editor`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
