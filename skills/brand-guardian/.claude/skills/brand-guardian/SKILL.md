...
# Brand Guardian — Claude Code wrapper

This is the **Claude Code wrapper** for `brand-guardian`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
