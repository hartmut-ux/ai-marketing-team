...
# Change Ci Coach — Codex CLI wrapper

This is the **Codex CLI wrapper** for `change-ci-coach`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
